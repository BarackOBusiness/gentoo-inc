...
MY_PN="svt-av1-tritium"
DESCRIPTION="Scalable Video Technology for AV1 (SVT-AV1 Encoder)"
HOMEPAGE="https://github.com/Uranite/${MY_PN}"

if [[ ${PV} = 9999 ]]; then
	inherit git-r3
	EGIT_REPO_URI="https://github.com/Uranite/${MY_PN}.git"
else
	SNAPSHOT="0f9d3f0006077e4f69bbd024c5c713f98e7f0662"
	SRC_URI="https://github.com/Uranite/${MY_PN}/archive/${SNAPSHOT}.tar.gz -> ${P}.tar.gz"

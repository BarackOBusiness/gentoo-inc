...
JPEG_TURBO_COMMIT="8ecba3647edb6dd940463fedf38ca33a8e2a73d1"
JPEG_TURBO_ARCHIVE="${JPEG_TURBO_COMMIT}.tar.gz"
...
SRC_URI="
	...
	jpegli? (
		https://github.com/libjpeg-turbo/libjpeg-turbo/archive/${JPEG_TURBO_ARCHIVE}
	)
	test? (
...
IUSE="gdk-pixbuf jpegli openexr test"
RESTRICT="!test? ( test )"
...
multilib_src_configure() {
	echo "doing the move!"
	mv -v ${WORKDIR}/libjpeg-turbo-${JPEG_TURBO_COMMIT}/* "${WORKDIR}/libjxl-0.9.1/third_party/libjpeg-turbo"
	...
	local mycmakeargs=(
		...
		-DJPEGXL_ENABLE_JPEGLI=$(usex jpegli ON OFF)
